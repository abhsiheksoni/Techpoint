...
<body>
	<div class="top-area">
            ...
            <center><h2>Admin Panel</h2></center> <a href="Adminn.jsp" class="button" style="float: right;background:crimson;color:white">Home</a>
        
        </div>
    
    
        <button class="H" onclick="window.location.href='Adminn.jsp' return false;">Home<button>
